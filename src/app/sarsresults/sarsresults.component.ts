...
export class SarsresultsComponent implements OnInit {
    ...
    ngOnInit(): void {
        if (
            ...
            localStorage.getItem("loginUserName").toLowerCase() == "egrifat" ||
            ...
            localStorage.getItem("loginUserName").toLowerCase() == "massadi" ||
    ...
    public getTableFromServer(
        ...
        this.http
            .post(
                "https://srv-apps:4433/WebService.asmx/GetAllSarscov2Results",
                {
